...
7) Grafana
    ...
    - Key pair: Select or create a new keypair
    - Click this link and copy the userdata https://github.com/cvamsikrishna11/devops-fully-automated/blob/installations/grafana-setup.sh
    - Launch Instance
...
Very helpful. Go conquer the world!!!
